...
const issueChatErrorMessages: Record<IssueChatErrorCode, IssueChatMessageEntry> = {
  ...
  missing_file_path: {
    body: "Add the repository file path in the file section before asking Inlaya to prepare the edit.",
    tone: "error",
  },
  missing_instruction: {
  ...
  missing_session_id: {
    body: "Start the sandbox first so Inlaya has a live workspace to edit.",
    tone: "error",
  },
  sandbox_not_running: {
